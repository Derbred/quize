...
public class Level1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Dialog dd =  getDialog();//показать диалоговое окно В ЭТОМ МЕСТЕ ВСЕ ЛОМАЕТСЯ И ОТКРЫВАЕТСЯ ДВАЖДЫ, ИЗ-ЗА ЧЕГО ДИАЛОГОВОЕ ОКНО В КОНЦЕ УРОВНЯ НЕ ОТКРЫВАЕТСЯdd = getDialog();//показать диалоговое окно В ЭТОМ МЕСТЕ ВСЕ ЛОМАЕТСЯ И ОТКРЫВАЕТСЯ ДВАЖДЫ, ИЗ-ЗА ЧЕГО ДИАЛОГОВОЕ ОКНО В КОНЦЕ УРОВНЯ НЕ ОТКРЫВАЕТСЯ
        dd.show();
        ...
        btnclose.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent i = new Intent(Level1.this, GameLevels.class);
                startActivity(i);
                finish();
        ...
        img_left.setOnTouchListener(new View.OnTouchListener() {
            ...
            public boolean onTouch(View v, MotionEvent event) {
                ...
                if (event.getAction()==MotionEvent.ACTION_DOWN){
                    ...
                    if (count==10){
                        dialogEnd = new Dialog( Level1.this);//Содаем новое диалоговое окно
